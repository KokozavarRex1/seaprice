    ...
    <>
      ...
      <div className="px-6 sm:px-8 pt-5 pb-8 mt-1 border-t border-parchment-line bg-[#F5EFDF]">
        ...
        <div className="text-[11.5px] text-muted-foreground mt-5 leading-relaxed pt-4 border-t border-parchment-line space-y-2">
          ...
          <p>
            <b>⚠️ Провери наличността сам:</b> тъй като нямаме договор с Booking за официално API, не можем да гарантираме, че стаята е свободна за избрания период. Преди да планираш, отвори хотела в <b>Booking.com</b> (или сайта за резервации, който ползваш) и увери се, че има свободни стаи за тези дати.
          </p>
        </div>
      </div>
    </>
